...
export class AddUserIdMultiTenant1785976863317 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "fixed_expenses" ADD CONSTRAINT "FK_68ea0384dbac40330f320c91d47" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "occasional_expenses" ADD CONSTRAINT "FK_c5a41295b8d03edf9abc770d694" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "occasional_expenses" DROP CONSTRAINT "FK_c5a41295b8d03edf9abc770d694"`);
        ...
        await queryRunner.query(`ALTER TABLE "fixed_expenses" DROP CONSTRAINT "FK_68ea0384dbac40330f320c91d47"`);
